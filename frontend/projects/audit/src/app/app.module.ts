...
import { HeaderMenuReportsComponent } from './home/header/header-menu-reports/header-menu-reports.component';

@NgModule({
  declarations: [AppComponent, HomeComponent, HeaderComponent, HeaderMenuReportsComponent],
  imports: [
    BrowserModule,
    SelectorModule,
    FormsModule,
