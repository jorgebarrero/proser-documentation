...
@Component({
  selector: "app-display-outbound-agents-pie",
  templateUrl: "./display-outbound-agents-pie.component.html",
  styleUrls: ["./display-outbound-agents-pie.component.scss"]
})
export class DisplayOutboundAgentsPieComponent implements OnInit {
