export class DashboardInboundModel {
  ...
  public fieldList() {
    return [
      { field_name: "dashboardInboundCallsIndicators", name: "indicadores_llamadas", text: "Indicadores" },
      { field_name: "dashboardInboundCurrentCallsIndicators", name: "indicadores_llamadas_actuales", text: "Llamadas actuales" },
