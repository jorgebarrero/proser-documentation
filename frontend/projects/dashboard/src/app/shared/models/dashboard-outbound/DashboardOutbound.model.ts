export class DashboardOutboundModel {
  ...
  constructor() {
    ...
    this.dashboardOutboundCurrentCallsIndicators = '';
  ...
  public fieldList() {
    return [
      { field_name: "dashboardOutboundCallsIndicators", name: "indicadores_llamadas", text: "Indicadores" },
      { field_name: "dashboardOutboundCurrentCallsIndicators", name: "indicadores_llamadas_actuales", text: "Llamadas actuales" },
