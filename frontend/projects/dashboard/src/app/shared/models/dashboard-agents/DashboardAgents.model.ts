export class DashboardAgentsModel {
  ...
  constructor() {
    this.dashboardAgentsCallsIndicators = '';
    this.dashboardAgentsCurrentCallsIndicators = '';
  ...
  public fieldList() {
    return [
      { field_name: "dashboardAgentsCallsIndicators", name: "indicadores_llamadas", text: "Indicadores" },
      { field_name: "dashboardAgentsCurrentCallsIndicators", name: "indicadores_llamadas_actuales", text: "Llamadas actuales" },
