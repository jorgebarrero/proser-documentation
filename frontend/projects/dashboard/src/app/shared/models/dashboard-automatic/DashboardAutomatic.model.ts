export class DashboardAutomaticModel {
  dashboardAutomaticCallsIndicators;
  dashboardAutomaticCurrentCallsIndicators;
  agentsPlannedTotal;
  ...
  constructor() {
    this.dashboardAutomaticCallsIndicators = '';
    this.dashboardAutomaticCurrentCallsIndicators = '';
  ...
  public fieldList() {
    return [
      { field_name: "dashboardAutomaticCallsIndicators", name: "indicadores_llamadas", text: "Indicadores" },
      { field_name: "dashboardAutomaticCurrentCallsIndicators", name: "indicadores_llamadas_actuales", text: "Llamadas actuales" },
