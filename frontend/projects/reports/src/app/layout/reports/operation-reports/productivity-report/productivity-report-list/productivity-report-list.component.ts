...
@Component({
  selector: 'app-reports-productivity-report-list',
  templateUrl: './productivity-report-list.component.html',
  styleUrls: ['./productivity-report-list.component.scss']
})
export class ProductivityReportListComponent implements OnInit {
