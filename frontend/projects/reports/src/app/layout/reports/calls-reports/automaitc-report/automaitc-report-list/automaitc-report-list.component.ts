...
@Component({
  selector: 'app-reports-automaitc-report-list',
  templateUrl: './automaitc-report-list.component.html',
  styleUrls: ['./automaitc-report-list.component.scss']
})
export class AutomaitcReportListComponent implements OnInit {
