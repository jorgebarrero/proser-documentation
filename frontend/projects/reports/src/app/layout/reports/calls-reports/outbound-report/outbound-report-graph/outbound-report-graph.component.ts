...
@Component({
  selector: "app-reports-outbound-report-graph",
  templateUrl: "./outbound-report-graph.component.html",
  styleUrls: ["./outbound-report-graph.component.scss"]
})
export class OutboundReportGraphComponent implements OnInit {
