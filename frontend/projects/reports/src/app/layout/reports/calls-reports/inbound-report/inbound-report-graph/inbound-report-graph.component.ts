...
import { numToShortWeekDay } from "shared/functions";

import * as moment from "moment";

@Component({
  selector: "app-reports-inbound-report-graph",
  templateUrl: "./inbound-report-graph.component.html",
  styleUrls: ["./inbound-report-graph.component.scss"]
})
export class InboundReportGraphComponent implements OnInit, OnDestroy {
    ...
    return rows.map(x => {
      return {
        ...
        graphLabel:
          ...
          "-" +
          numToShortWeekDay(parseInt(moment(x.start_date).format("e")))
      };
    });
  }
