...
export class CrudInvSupervisorDetailComponent implements OnInit {
  ...
  onFillForm() {
    ...
    this.registerForm = this.formBuilder.group({
      ...
      inv_supervisor_shortname: [this.selection.inv_supervisor_shortname],
      inv_supervisor_legal_id: [this.selection.inv_supervisor_legal_id],
      inv_supervisor_internal_id: [this.selection.inv_supervisor_internal_id],
