...
export class SelectorComponent implements OnInit, OnDestroy {
  ...
  onReset() {
    ...
    localStorage.setItem(this.store, JSON.stringify(proser_store));
    this.ngOnInit();
  }
  ...
  onSubmit(currentSelection) {
    ...
    this.store === "proser_store"
      ? this.userSelectionService.writeUserSelection(currentSelection)
      : this.userSelectionService.writeUserSelectionCurrent(currentSelection);
  ...
  onChange() {
    ...
    let currentSelection = this.selectorForm.value;
  ...
  onLastMinutes() {
    ...
    this.store === "proser_store"
      ...
      : this.userSelectionService.writeUserSelectionCurrent(
          this.selectorForm.value
        );
  }
  ...
  getUserSelectionMenus() {
    this.store === "proser_store"
      ...
      : (this.selection = this.userSelectionService.readUserSelectionCurrent());
